...
export const CLASS_DATA: Record<string, ClassPerksSkills> = {
  ...
  Rogue: {
    ...
    skills: [
      ...
      { name: "Sneak Attack", description: "Your next attack from stealth deals greatly increased damage and cannot be blocked." },
  ...
  Ranger: {
    perks: [
      ...
      { name: "Longshot Expert", description: "Increase physical damage by 10% when hitting targets beyond 10m." },
      { name: "Nimble Hands", description: "Increase action speed by 15% when using a bow." },
      { name: "Point-Blank Expert", description: "Increase physical damage by 10% when hitting targets within 3m." },
      ...
      { name: "Windfletch", description: "Arrows travel 20% faster and are less affected by gravity." },
    ],
    skills: [
      { name: "Explosive Shot", description: "Fire an arrow tipped with explosive material that detonates on impact, dealing area damage." },
