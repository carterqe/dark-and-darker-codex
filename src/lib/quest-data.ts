...
export const TRADERS: Trader[] = [
  // ─── ALCHEMIST ─────────────────────────────────────────────────────────────
  {
    ...
    quests: [
      ...
      // Chapter 4 – Land for Alchemy
      {
        ...
        requirements: [
          { type: "kill", monster: "Lava Turtle", location: "The Ashen Range", quantity: 7, description: "Kill 7 Lava Turtles in The Ashen Range" },
      ...
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Lava Slime", location: "The Ashen Range", quantity: 5, description: "Kill 5 Lava Slimes in The Ashen Range" },
      ...
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Fire Spirit", location: "The Ashen Range", quantity: 3, description: "Kill 3 Fire Spirits in The Ashen Range" },
  ...
  // ─── GOBLIN MERCHANT ───────────────────────────────────────────────────────
  {
    ...
    quests: [
      // Chapter 1 – Kin No More
      {
        ...
        chapter: "Kin No More",
        description: "My kin make for lousy business partners. Thin their numbers in The Ashen Range.",
        requirements: [
          { type: "kill", monster: "Goblin Axeman", location: "The Ashen Range", quantity: 3, description: "Kill 3 Goblin Axemen in The Ashen Range" },
          { type: "kill", monster: "Goblin Warrior", location: "The Ashen Range", quantity: 3, description: "Kill 3 Goblin Warriors in The Ashen Range" },
          { type: "kill", monster: "Goblin Archer", location: "The Ashen Range", quantity: 3, description: "Kill 3 Goblin Archers in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        requirements: [
          { type: "explore", location: "The Ashen Range — Cave Altar A", quantity: 1, description: "Explore the Cave Altar in The Ashen Range" },
        ],
        reward: { gold: 30, xp: 25, description: "30 Gold, Random Uncommon Weapon, +25 XP" },
      },
      {
      ...
      // Chapter 2 – Make Them Pay
      {
        ...
        description: "A bug shell from The Ashen Range — don't ask what I'm cooking. You don't want to know.",
        requirements: [
      ...
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Goblin Mage", location: "The Ashen Range", quantity: 3, description: "Kill 3 Goblin Mages in The Ashen Range" },
          { type: "kill", monster: "Giant Centipede", location: "The Ashen Range", quantity: 2, description: "Kill 2 Giant Centipedes in The Ashen Range" },
          { type: "kill", monster: "Giant Spider", location: "The Ashen Range", quantity: 3, description: "Kill 3 Giant Spiders in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        name: "The Way Out",
        chapter: "Make Them Pay",
        description: "Surviving The Ashen Range is harder than it looks. Prove you can do it repeatedly.",
        requirements: [
          { type: "survive", location: "The Ashen Range", quantity: 3, description: "Survive 3 runs in The Ashen Range" },
        ],
      ...
      // Chapter 3 – Gobbo's Little Trick
      {
        ...
        description: "The ash piles in The Ashen Range hide things my kin left behind. Sift through them.",
        requirements: [
          { type: "interact", item: "Ash Pile", location: "The Ashen Range", quantity: 5, description: "Search 5 Ash Piles in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Fire Lizard", location: "The Ashen Range", quantity: 10, description: "Kill 10 Fire Lizards in The Ashen Range" },
      ...
      // Chapter 4 – Favorite Soft Skin
      {
        ...
        requirements: [
          { type: "kill", monster: "Death Beetle", location: "The Ashen Range", quantity: 5, description: "Kill 5 Death Beetles in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        name: "Crate Chaos",
        chapter: "Favorite Soft Skin",
        description: "The Dwarven crates in The Ashen Range are full of junk — but my junk. Smash them.",
        requirements: [
          { type: "destroy", item: "Dwarven Small Wooden Crate", location: "The Ashen Range", quantity: 15, description: "Destroy 15 Dwarven Small Wooden Crates in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Beast Goblin", location: "The Ashen Range", quantity: 12, description: "Kill 12 Beast Goblins in The Ashen Range (single session)" },
        ],
      ...
      // Chapter 5 – Greater Threats
      {
        ...
        description: "The Lion's Head chests in The Ashen Range are where my kin stash their best loot. Open two in a single run.",
        requirements: [
          { type: "interact", item: "Lion's Head Chest", location: "The Ashen Range", quantity: 2, description: "Open 2 Lion's Head Chests in The Ashen Range (single session)" },
        ],
        reward: { gold: 150, xp: 300, affinity: 25, description: "150 Gold, 2× Random Rare Armor, +300 XP, +25 Affinity" },
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Giant Centipede", location: "The Ashen Range", quantity: 2, description: "Kill 2 Giant Centipedes in The Ashen Range" },
          { type: "explore", location: "The Ashen Range — Cave Pit Hall", quantity: 1, description: "Explore the Cave Pit Hall in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        name: "One Eyed Foe",
        chapter: "Greater Threats",
        description: "The Cyclops is the biggest bully in The Ashen Range — and I want his territory.",
        requirements: [
          { type: "kill", monster: "Cyclops", location: "The Ashen Range", quantity: 1, description: "Kill the Cyclops in The Ashen Range" },
        ],
  ...
  // ─── MINER ─────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "A weathered dwarf who has seen The Ashen Range's fiery depths firsthand. He deals in ore, lava materials, and the remnants of his fallen kin.",
    accentColor: "#c4783a",
    quests: [
      // Chapter 1 – Into the Firedeep
      {
        ...
        requirements: [
          { type: "survive", location: "The Ashen Range", quantity: 1, description: "Survive 1 run in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        chapter: "Into the Firedeep",
        description: "The Broken Stone Bridge module in The Ashen Range is where my kin fell. I need to know what's left.",
        requirements: [
          { type: "explore", location: "The Ashen Range — Broken Stone Bridge", quantity: 1, description: "Explore the Broken Stone Bridge in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        chapter: "Into the Firedeep",
        description: "Dwarf soldiers bound to the fire still patrol The Ashen Range. End their suffering.",
        requirements: [
          { type: "kill", monster: "Dwarf Handcannoneer", location: "The Ashen Range", quantity: 5, description: "Kill 5 Dwarf Handcannoneers in The Ashen Range" },
          { type: "kill", monster: "Dwarf Mauler", location: "The Ashen Range", quantity: 5, description: "Kill 5 Dwarf Maulers in The Ashen Range" },
          { type: "kill", monster: "Dwarf Axeman", location: "The Ashen Range", quantity: 5, description: "Kill 5 Dwarf Axemen in The Ashen Range" },
        ],
      ...
      // Chapter 2 – The Broken Remains
      {
        ...
        description: "Flame Boars have overrun sections of The Ashen Range. Cull them and bring back their tusks.",
        requirements: [
          { type: "kill", monster: "Flame Boar", location: "The Ashen Range", quantity: 10, description: "Kill 10 Flame Boars in The Ashen Range" },
      ...
      },
      {
        ...
        chapter: "The Broken Remains",
        description: "Fallen Dwarves throughout The Ashen Range carry messages I never received. Recover them.",
        requirements: [
          { type: "interact", item: "Fallen Dwarf", location: "The Ashen Range", quantity: 10, description: "Inspect 10 Fallen Dwarves in The Ashen Range" },
        ],
        reward: { gold: 125, xp: 250, description: "125 Gold, 2× Random Rare Weapon, +250 XP" },
      },
      {
      ...
      // Chapter 3 – The Fire That Will Not End
      {
        ...
        requirements: [
          { type: "explore", location: "The Ashen Range — Burning Court", quantity: 1, description: "Explore the Burning Court in The Ashen Range" },
        ],
        reward: { gold: 150, xp: 300, description: "150 Gold, 2× Random Epic Armor, +300 XP" },
      },
      {
  ...
  // ─── TAILOR ────────────────────────────────────────────────────────────────
  {
    ...
    quests: [
      ...
      },
      {
        ...
        requirements: [
          { type: "interact", item: "Shrine of Health", location: "The Ashen Range", quantity: 4, description: "Interact with 4 Shrines of Health in The Ashen Range" },
        ],
  ...
  // ─── WEAPONSMITH ───────────────────────────────────────────────────────────
  {
    ...
    quests: [
      ...
      // Chapter 3 – Traces of the Dwarves
      {
        ...
        description: "The Magma Falls in The Ashen Range is where the Dwarves once ran their foundries. Go see what remains.",
        requirements: [
          { type: "explore", location: "The Ashen Range — Magma Falls", quantity: 1, description: "Explore the Magma Falls module in The Ashen Range" },
        ],
      ...
      },
      {
        ...
        chapter: "Traces of the Dwarves",
        description: "Obsidian ore from The Ashen Range is harder than anything I've worked with. I need samples.",
        requirements: [
      ...
      },
      {
        ...
        requirements: [
          { type: "kill", monster: "Dwarf Handcannoneer", location: "The Ashen Range", quantity: 10, description: "Kill 10 Dwarf Handcannoneers in The Ashen Range" },
          { type: "kill", monster: "Dwarf Mauler", location: "The Ashen Range", quantity: 10, description: "Kill 10 Dwarf Maulers in The Ashen Range" },
